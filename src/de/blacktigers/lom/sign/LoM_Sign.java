package de.blacktigers.lom.sign;
...
import de.blacktigers.lom.data.LoMLocation;
...
public class LoM_Sign implements Serializable{
	...
	public LoM_Sign(String name2, LoM_SignType type, Location location) {
		this.type = type;
		Arena = LeagueOfMinecraft.getPlugin().Arenas;
		maxplayer = LeagueOfMinecraft.getPlugin().getConfig().getInt("arena.maxPlayer");
			name = name2;
