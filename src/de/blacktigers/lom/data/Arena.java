...
import de.blacktigers.lom.events.GameStartEvent;
...
public class Arena implements Serializable {
	...
	public void startCountdown(){
		...
		gameCountdownTimer = LeagueOfMinecraft.getPlugin().getServer().getScheduler().scheduleSyncRepeatingTask(LeagueOfMinecraft.getPlugin(), new Runnable(){
	...
	public void stopCountdown(){
		LeagueOfMinecraft.getPlugin().getServer().getScheduler().cancelTask(gameCountdownTimer);
