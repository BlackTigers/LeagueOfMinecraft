...
import de.blacktigers.lom.ce.CE_LoM;
import de.blacktigers.lom.data.Arena;
import de.blacktigers.lom.data.Config;
import de.blacktigers.lom.data.ConfigCreator;
import de.blacktigers.lom.data.InvSave;
import de.blacktigers.lom.data.Metrics;
import de.blacktigers.lom.data.SL;
import de.blacktigers.lom.listener.L_Combat;
import de.blacktigers.lom.listener.L_Player;
import de.blacktigers.lom.shop.Shop;
...
public class LeagueOfMinecraft extends JavaPlugin {
    ...
    public static LeagueOfMinecraft getPlugin() {
    	return (LeagueOfMinecraft) Bukkit.getPluginManager().getPlugin("League of Minecraft");
    }
